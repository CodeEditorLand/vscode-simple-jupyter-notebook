 ...
 */
export type DebugRequestMessage = JupyterMessage<
	"debug_request",
 ...
 * part of the public API, and may change without notice.
 */
export type DebugReplyMessage = JupyterMessage<
	"debug_reply",
 ...
 * part of the public API, and may change without notice.
 */
export type DebugEventMessage = JupyterMessage<
	"debug_event",
	DebugProtocol.Event,
	"iopub"
>;
...
): test is TypedJupyerMessage & JupyterMessage<T> =>
	test.header.msg_type === messageType;

//#region factories

// this exists in nteract/messaging, but is not exported:
const createHeader = <MT extends MessageType>(
	messageType: MT,
...
export const debugRequest = simpleFactory<DebugRequestMessage>(
	"debug_request",
	"control",
);
