...
If there is no xpython entry that's an indication that we can't find a Jupyter
...
The debugger available in the xeus kernel is surfaced as a VS Code debugger of
